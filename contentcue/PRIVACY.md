...
The app stores the following data locally on your device. None of this is transmitted to us or any third party.

| Data | Storage Location | Purpose |
|------|-----------------|---------|
| Audio mute preference | UserDefaults | Remember your playback setting |
...
You can clear all local data at any time by deleting the app from your device.

---

## 3. Apple StoreKit

ContentCue offers an optional Pro upgrade via a one-time in-app purchase, handled by Apple StoreKit 2.
...
ContentCue does not integrate with any third-party analytics, advertising, or tracking SDKs. There are no third-party frameworks included in the app.

---

## 6. Data Deletion

All data is stored locally on your device. To remove it:
...
ContentCue does not collect any information from any users, including children. However, because it provides unrestricted web browsing access, it is rated 12+ on the App Store.
